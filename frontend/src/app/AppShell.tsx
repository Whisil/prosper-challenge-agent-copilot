...
export function AppShell() {
  const { agent, selectedNode, selectedNodeName, selectNode } = useAgentGraph()
    ...
    <div className="flex h-screen min-h-[640px] overflow-hidden bg-[#f7f7f5]">
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex min-h-0 flex-1">
          <div className="min-w-0 flex-1"><AgentGraph config={agent} selectedNodeName={selectedNodeName} onSelectNode={selectNode} /></div>
