...
import type { CallRecord, CallReview, ImprovementRecord } from "@/features/agent-graph/model/type"
import { summarizeTraceEvent } from "../lib/callHistoryStorage"

interface CallHistoryWorkspaceProps {
  records: CallRecord[]
  improvementRecords?: ImprovementRecord[]
